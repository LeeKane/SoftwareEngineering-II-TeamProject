...
//		accountModel.removeRow(selectedRow);
	...
	protected void showAccount(){
		...
		po=new AccountPO(accountvo.getId(), accountvo.getPermission1(), accountvo.getUsername(), accountvo.getPassword());
		//po=new AccountPO(151232, Permission.toPermission("快递员"), "mailer", "123456");		
