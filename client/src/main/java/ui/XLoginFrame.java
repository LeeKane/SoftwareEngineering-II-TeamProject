...
public class XLoginFrame extends JFrame
{
	...
	public XLoginFrame()
	{
		...
		buttonPressedIcon = XContorlUtil.getImageIcon("ui/images/login_button_pressed.png");
		logoIcon = XContorlUtil.getImageIcon("ui/images/login_logo.png");

		logoRoverIcon = XContorlUtil.getImageIcon("ui/images/login_logo_rover.png");
		logoLabel = createDraggableLabel(logoIcon);
		btnLogin = new JButton();
		inputPane = new JPanel() {
			private TexturePaint paint = XContorlUtil.createTexturePaint("ui/images/login_background.png");
	...
	private void init()
	{
		...
		topPane.add(createDraggableLabel(XContorlUtil.getImageIcon("ui/images/login_left_top.png")), "West");
		topPane.add(createDraggableLabel(XContorlUtil.getImageIcon("ui/images/login_right_top.png")), "East");
	

		centerPane.add(createDraggableLabel(XContorlUtil.getImageIcon("ui/images/login_left.png")), "West");
		centerPane.add(createDraggableLabel(XContorlUtil.getImageIcon("ui/images/login_right.png")), "East");
