...
public class XToolBar extends JPanel
{
	...
	public XToolBar()
	{
		preferredHeight = XContorlUtil.getImageIcon("ui/images/toolbar_background.png").getIconHeight();
		paint = XContorlUtil.createTexturePaint("ui/images/toolbar_background.png");
		buttonGap = 2;
		init();
	}
