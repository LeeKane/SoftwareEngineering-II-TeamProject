...
public class WareOutBLserviceImpl implements WareOutBLservice {
	...
	public void addWareOut(long id, TimePO time, City destination, Vehicle vehicle, long transid, GaragePlacePO place) {
		...
		WareOutListVO vo = new WareOutListVO(ListType.STOCKOUT, id, time, vehicle, destination, transid,
				ListState.SUBMITTED);
		WareOutListPO ppo = new WareOutListPO(id, time, vehicle, destination, transid, ListState.SUBMITTED,
	...
	/*
	 * public static void main (String[] args){ WareOutBLserviceImpl wb=new
	 * WareOutBLserviceImpl(); wb.addWareOut(746413,new
	 * TimePO(2,1,2,1,2,1),City.BEIJING,Vehicle.PLANE,4567); }
	 */
	@Override
	...
	@Override
	public ArrayList<GarageBodyPO> getWareIn(TimePO start, TimePO end)
			throws NumberFormatException, RemoteException, IOException {
		// TODO Auto-generated method stub
	...
	public ArrayList<GarageBodyPO> getWareOut(TimePO start, TimePO end)
			throws NumberFormatException, RemoteException, IOException {
		// TODO Auto-generated method stub
		ArrayList<GarageBodyPO> list = new ArrayList<GarageBodyPO>();
