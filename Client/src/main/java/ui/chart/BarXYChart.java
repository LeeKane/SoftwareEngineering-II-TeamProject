...
public class BarXYChart extends XChartPanellet {
	public BarXYChart() {
		...
		JFreeChart chart = ChartFactory.createXYBarChart("时间柱状图", "Date", true, "rian", getDataset(),
		...
		// 设置bar的paint
		clusteredXYBarRenderer.setSeriesPaint(0,
				new GradientPaint(0.0F, 0.0F, Color.RED, 0.0F, 0.0F, new Color(0, 0, 64)));
		clusteredXYBarRenderer.setSeriesPaint(1,
				new GradientPaint(0.0F, 0.0F, Color.GREEN, 0.0F, 0.0F, new Color(0, 0, 64)));
		// 设置渲染器
