...
public class Bar3DChart extends XChartPanellet {
	public Bar3DChart() {
		...
		JFreeChart jfreechart = ChartFactory.createBarChart3D("降雨量", "省份", "雨量", getDataset(), PlotOrientation.VERTICAL,
				false, true, false);
		...
		// 警戒线
		ValueMarker valuemarker = new ValueMarker(180.00D, new Color(200, 200, 255), new BasicStroke(1.0F),
