...
public class XProgressBar extends JProgressBar {
	...
	public XProgressBar(int value, int min, int max) {
		...
		selectedBackgroundLeft = XContorlUtil.getImage("ui/images/progress_select_background.png");
		selectedBackgroundRight = XContorlUtil.getImage("ui/images/progress_select_background.png");
		selectedPaint = XContorlUtil.createTexturePaint("ui/images/progress_select_background.png");
		unselectedPaint = XContorlUtil.createTexturePaint("ui/images/progress_unselect_background.png");
