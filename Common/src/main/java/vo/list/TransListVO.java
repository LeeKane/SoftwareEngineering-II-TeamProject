...
public class TransListVO extends Vector<String> implements Serializable {
	...
	public TransListVO(ListType type, TimePO time, long id, long transID, City startCity, City endCity, long transboxID,
			String supersivor, long[] orderlist, double yunfei) {
		super();
		this.type = type;
		this.time = time;
		this.id = id;
