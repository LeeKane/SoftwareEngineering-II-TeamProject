...
public class WareVO extends Vector<String> implements Serializable {
	...
	public WareVO(double weight, int amount, double volume, String packag, String name, DeliverType type, double cost,
			TimePO time, long id, City departPlace, City destination) {
		this.add("" + weight);
		this.add("" + amount);
		this.add("" + volume);
		this.add("" + packag);
