...
public class CostchartPO implements Serializable {
	...
	public CostchartPO(ListType moneyin, TimePO paytime, double paymoney, String payer, String payaccount, double rent,
			TimePO rentyear, double freight, long waybillnum, double wages, TimePO wagesmonth, double reward,
			RewardType rewardtype) {
