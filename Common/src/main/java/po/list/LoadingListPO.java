...
public class LoadingListPO implements Serializable {
	...
	public LoadingListPO(long id, ListType type, TimePO loadDate, long transNum, City departPlace, City destination,
			ArrayList<Long> waybillNumList, String loadMonitor, String loadPerformer, double freight, ListState lst) {
		super();
		this.id = id;
		this.type = type;
