...
public class OrderListPO implements Serializable {
	 ...
	 *            收件人单位
	 * @param receiverTphone
	 *            收件人电话
	 * @param receiverCphone
	 *            收件人手机
	 * @param lst
	 *            单据状态
	 */

	public OrderListPO(ListType listType, String senderName, String senaderAddress, String senderOrganization,
			String senderTphone, String senderCphone, String receiverName, String receiverAddress,
			String receiverOrganization, String receiverTphone, String receiverCphone, WarePO ware, String id,
			ListState lst, String account) {
		super();
